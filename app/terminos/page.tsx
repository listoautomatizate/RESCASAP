  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-document">
        ...
        <section><h2>5. Reserva y formas de pago</h2><p>Cada comercio puede ofrecer pago al retirar y, cuando vincule su propia cuenta, pago online mediante Checkout Pro de Mercado Pago. En el pago online, el consumidor sale temporalmente al entorno seguro de Mercado Pago; RESCASAP no recibe ni almacena datos de tarjetas. El dinero se acredita en la cuenta del comercio, que emite la documentación fiscal aplicable. Durante el piloto la comisión de plataforma de RESCASAP es 0; Mercado Pago puede aplicar sus propios cargos y condiciones. La reserva online queda confirmada cuando la plataforma verifica la acreditación con Mercado Pago, no por la sola pantalla de regreso.</p></section>
        <section><h2>6. Retiro, cancelación y no presentación</h2><p>El consumidor debe retirar dentro de la franja indicada y mostrar su código. Puede solicitar la cancelación desde la aplicación mientras la reserva siga activa y antes del retiro. Si el pago fue online, RESCASAP cursará la cancelación o devolución mediante Mercado Pago y su acreditación puede depender de los plazos del medio de pago. Si no se presenta, el comercio puede marcar la reserva como no retirada. Si el comercio no puede entregar, deberá cancelar o coordinar una solución sin afectar los derechos irrenunciables del consumidor.</p></section>
