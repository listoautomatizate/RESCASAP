  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-document">
        ...
        <section><h2>5. Cobro y documentación</h2><p>Durante el piloto, el comercio cobra directamente al consumidor al retirar y emite la documentación fiscal correspondiente. RESCASAP no recibe ni custodia ese dinero. El piloto no tiene comisión de plataforma; cualquier comisión, abono o integración de pagos futura requerirá condiciones comerciales adicionales aceptadas por separado.</p></section>
